...
![Screenshot](img/p2.png)
 ...
 ### 12.2.1 Pertanyaan 
 1. Jelaskan fungsi masing-masing statement pada potongan kode removeFirst() berikut:
 : 
 * head = head.next; Berfungsi untuk menggeser posisi pointer head ke node berikutnya di dalam list. Hal ini secara efektif memutus hubungan node pertama yang lama dari penanda awal list.
