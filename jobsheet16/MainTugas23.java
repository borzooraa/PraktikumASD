...
public class MainTugas23 {
    List<Mahasiswa23> listMahasiswa = new ArrayList<>();
    List<MataKuliah23> listMK = new ArrayList<>();
    List<Nilai23> listNilai = new ArrayList<>();
    Queue<Mahasiswa23> queueHapusMhs = new LinkedList<>();

    public void initData() {
        listMahasiswa.add(new Mahasiswa23("20023", "Thalhah", "021xxx"));
        listMahasiswa.add(new Mahasiswa23("20002", "Zubair", "021xxx"));
        listMahasiswa.add(new Mahasiswa23("20003", "Abdur-Rahman", "021xxx"));
        listMahasiswa.add(new Mahasiswa23("20004", "Sa'ad", "021xxx"));
        listMahasiswa.add(new Mahasiswa23("20005", "Sa'id", "021xxx"));
        listMahasiswa.add(new Mahasiswa23("20006", "Ubaidah", "021xxx"));

        listMK.add(new MataKuliah23("00023", "Internet of Things", 3));
        listMK.add(new MataKuliah23("00002", "Algoritma dan Struktur Data", 2));
        listMK.add(new MataKuliah23("00003", "Algoritma dan Pemrograman", 2));
        listMK.add(new MataKuliah23("00004", "Praktikum Algoritma dan Struktur Data", 3));
        listMK.add(new MataKuliah23("00005", "Praktikum Algoritma dan Pemrograman", 3));
    }
    ...
    public void tampilMahasiswa() {
        ...
        for (Mahasiswa23 m : listMahasiswa) {
    ...
    public void inputNilai(Scanner sc) {
        ...
        if (mhsTerpilih != null && mkTerpilih != null) {
            listNilai.add(new Nilai23(mhsTerpilih, mkTerpilih, nilaiInput));
        }
    }
    ...
    public void eksekusiHapus() {
        if (!queueHapusMhs.isEmpty()) {
            Mahasiswa23 mhs = queueHapusMhs.poll();
    ...
    public static void main(String[] args) {
        MainTugas23 app = new MainTugas23();
        app.initData();
