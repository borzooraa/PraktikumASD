public class BinaryTreeMain23 {
    public static void main(String[] args) {
        ...
        bst.add(new Mahasiswa23("244162321", "Ali", "A", 3.57));
        bst.add(new Mahasiswa23("244160221", "Badar", "B", 3.85));
        bst.add(new Mahasiswa23("244162385", "Candra", "C", 3.21));
        ...
        String hasilCari = bst.find(3.54)
                ? "Ditemukan"
                : "Tidak ditemukan";
        ...
        bst.add(new Mahasiswa23("244162331", "Devi", "A", 3.72));
        bst.add(new Mahasiswa23("244160205", "Ehsan", "D", 3.37));
        bst.add(new Mahasiswa23("244162370", "Fizi", "B", 3.46));
